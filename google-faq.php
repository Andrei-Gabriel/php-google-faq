...
<body>
    ...
    <img style="display: block; margin: 40px auto; height: 150px" src="google.svg" alt="Google Logo">

    <?php 
        foreach ($faq as $faqSingole){
            echo "<h2>{$faqSingole["domanda"]}</h3>";
            echo "<ul>";
            foreach ($faqSingole["risposta"] as $answer){
                echo "<li>{$answer}</li>";
            }
            echo "</ul>";
        }
